...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_bank_statement_imports_status"),
        "bank_statement_imports",
        ["status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_chart_of_accounts_is_active"),
        "chart_of_accounts",
        ["is_active"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "edited_payload", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_review_items_review_type"),
        "review_items",
        ["review_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_bank_transactions_amount"),
        "bank_transactions",
        ["amount"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bank_transactions_bank_statement_import_id"),
        "bank_transactions",
        ["bank_statement_import_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_journal_entries_extraction_id"),
        "journal_entries",
        ["extraction_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_reconciliation_matches_journal_entry_id"),
        "reconciliation_matches",
        ["journal_entry_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reconciliation_matches_status"),
        "reconciliation_matches",
        ["status"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_reconciliation_matches_status"), table_name="reconciliation_matches"
    )
    op.drop_index(
        op.f("ix_reconciliation_matches_journal_entry_id"),
    ...
    op.drop_index(
        op.f("ix_journal_entry_lines_account_id"), table_name="journal_entry_lines"
    )
    op.drop_table("journal_entry_lines")
    op.drop_index(op.f("ix_journal_entries_status"), table_name="journal_entries")
    op.drop_index(
        op.f("ix_journal_entries_extraction_id"), table_name="journal_entries"
    )
    ...
    op.drop_index(
        op.f("ix_document_extractions_status"), table_name="document_extractions"
    )
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_chart_of_accounts_is_active"), table_name="chart_of_accounts"
    )
    op.drop_index(
        op.f("ix_chart_of_accounts_account_type"), table_name="chart_of_accounts"
    )
    op.drop_index(
        op.f("ix_chart_of_accounts_account_code"), table_name="chart_of_accounts"
    )
    op.drop_table("chart_of_accounts")
    op.drop_index(
        op.f("ix_bank_statement_imports_status"), table_name="bank_statement_imports"
    )
